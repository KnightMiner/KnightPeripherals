...
public class FakePlayerProvider {
	...
	private static GameProfile profile = new GameProfile(UUID.fromString("6b49a094-c3de-11e5-9912-ba0be0483c18"), "KnightPeripherals");
	
	/**
	 * Get a fake player with the position and world set to the turtle's position and world
	 * @param turtle Turtle getting the fake player

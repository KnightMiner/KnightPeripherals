...
{	
	...
	public Pair<IBakedModel, Matrix4f> getModel(ITurtleAccess turtle, TurtleSide side) {
    	if (modelLeft == null)
    	{
			...
			modelLeft = manager.getModel(new ModelResourceLocation(Reference.RESOURCE_LOCATION + ":turtle_tnt_left", "inventory"));
			modelRight = manager.getModel(new ModelResourceLocation(Reference.RESOURCE_LOCATION + ":turtle_tnt_right", "inventory"));
    	}
